...
public final class HDAng {
     ...
     */
    public HDAng(double ang) { set(ang); }
    /**
     ...
     */
    public HDAng(double ang, double x, double y, double z) { set(ang, x, y, z); }
    /**
     ...
     * @param ang The rotation angle in radians
     */
    public HDAng(double ang, HDVec vec) { set(ang, vec); }
    /**
     * Creates a new rotation object which is a copy of the provided object.
     * @param ang The rotation object.
     */
    public HDAng(HDAng ang) { set(ang); }
    private final HDVec vec = new HDVec(0.0, 0.0, 1.0);
    private final double[] dat = new double[3];
     ...
     * @return This
     */
    public HDAng set(double x, double y, double z) { this.vec.set(x, y, z); return this; }
    /**
     ...
     * @return This
     */
    public HDAng set(HDVec vec) { this.vec.set(vec); return this; }
    /**
    ...
    { dat[0] = ang; dat[1] = Math.sin(ang); dat[2] = Math.cos(ang); return this; }
    /**
     * 
     * Sets the X, Y, and Z components of the rotation vector to the provided
     ...
     * @return This
     */
    public HDAng set(double ang, HDVec vec) { set(vec); return set(ang); }
    /**
     ...
     */
    public HDVec vec() { return vec; }
    /**
     * Returns the rotation angle.
     * @return 
     */
    public double ang() { return dat[0]; }
    /**
     * Returns the sine of the rotation angle.
     * @return 
     */
    public double sin() { return dat[1]; }
    /**
     * Returns the cosine of the rotation angle.
     * @return 
     */
    public double cos() { return dat[2]; }
}
