 ...
 * @author Arthur
 */
public final class HDQRef {
	// The Static Methods

	private static final BigDecimal[] IDENTITY = new BigDecimal[]{ONE, ZERO, ZERO, ZERO, ZERO, ONE, ZERO, ZERO, ZERO, ZERO, ONE, ZERO, ZERO, ZERO, ZERO, ONE};
	 ...
	 */
	public static HDQRef mult(HDQRef ref1, HDQRef ref2) {
	 ...
	 * @return The final reference frame
	 */
	public static HDQRef mult(HDQRef ref1, HDQRef ref2, HDQRef target) {
		BigDecimal[] d = new BigDecimal[16];
		d[0] = (ref1.dat[0].multiply(ref2.dat[0])).add(ref1.dat[4].multiply(ref2.dat[1])).add(ref1.dat[8].multiply(ref2.dat[2]));
		d[1] = (ref1.dat[1].multiply(ref2.dat[0])).add(ref1.dat[5].multiply(ref2.dat[1])).add(ref1.dat[9].multiply(ref2.dat[2]));
		d[2] = (ref1.dat[2].multiply(ref2.dat[0])).add(ref1.dat[6].multiply(ref2.dat[1])).add(ref1.dat[10].multiply(ref2.dat[2]));
		d[4] = (ref1.dat[0].multiply(ref2.dat[4])).add(ref1.dat[4].multiply(ref2.dat[5])).add(ref1.dat[8].multiply(ref2.dat[6]));
		d[5] = (ref1.dat[1].multiply(ref2.dat[4])).add(ref1.dat[5].multiply(ref2.dat[5])).add(ref1.dat[9].multiply(ref2.dat[6]));
		d[6] = (ref1.dat[2].multiply(ref2.dat[4])).add(ref1.dat[6].multiply(ref2.dat[5])).add(ref1.dat[10].multiply(ref2.dat[6]));
		d[8] = (ref1.dat[0].multiply(ref2.dat[8])).add(ref1.dat[4].multiply(ref2.dat[9])).add(ref1.dat[8].multiply(ref2.dat[10]));
		d[9] = (ref1.dat[1].multiply(ref2.dat[8])).add(ref1.dat[5].multiply(ref2.dat[9])).add(ref1.dat[9].multiply(ref2.dat[10]));
		d[10] = (ref1.dat[2].multiply(ref2.dat[8])).add(ref1.dat[6].multiply(ref2.dat[9])).add(ref1.dat[10].multiply(ref2.dat[10]));
		d[12] = (ref1.dat[0].multiply(ref2.dat[12])).add(ref1.dat[4].multiply(ref2.dat[13])).add(ref1.dat[8].multiply(ref2.dat[14])).add(ref1.dat[12]);
		d[13] = (ref1.dat[1].multiply(ref2.dat[12])).add(ref1.dat[5].multiply(ref2.dat[13])).add(ref1.dat[9].multiply(ref2.dat[14])).add(ref1.dat[13]);
		d[14] = (ref1.dat[2].multiply(ref2.dat[12])).add(ref1.dat[6].multiply(ref2.dat[13])).add(ref1.dat[10].multiply(ref2.dat[14])).add(ref1.dat[14]);
		d[15] = ONE;
		return target != null ? target.set(d) : new HDQRef(d);
	}
	 ...
	 */
	public HDQRef(HDQVec vecA, HDQVec vecB, HDQVec vecC) {
		set(vecA, vecB, vecC);
	}
	 ...
	 */
	public HDQRef(BigDecimal[] matrix) {
		set(matrix);
	}
	 ...
	 * @return This
	 */
	public HDQRef set(HDQVec vecA, HDQVec vecB, HDQVec vecC) {
	 ...
	 * @return This
	 */
	public HDQRef set(BigDecimal[] matrix) {
		if (matrix.length == dat.length) {
			System.arraycopy(matrix, 0, dat, 0, 16);
			modified = true;
		} else {
			throw new IllegalArgumentException("Array must be of length 16! Found " + matrix.length + ".");
		}
		return this;
	}
	...
	public HDQRef invert() {
		...
		d[9] = dat[6];
		d[10] = dat[10];
		d[12] = (dat[0].multiply(dat[12]).add(dat[1].multiply(dat[13])).add(dat[2].multiply(dat[14]))).negate();
		d[13] = (dat[4].multiply(dat[12]).add(dat[5].multiply(dat[13])).add(dat[6].multiply(dat[14]))).negate();
		d[14] = (dat[8].multiply(dat[12]).add(dat[9].multiply(dat[13])).add(dat[10].multiply(dat[14]))).negate();
		d[15] = ONE;
		return set(d);
	}
	 ...
	 * @return This
	 */
	public HDQRef translateLocally(HDQVec vec) {
	 ...
	 * @return This
	 */
	public HDQRef translateGlobally(HDQVec vec) {
		dat[12] = dat[12].add(dat[0].multiply(vec.X())).add(dat[4].multiply(vec.Y())).add(dat[8].multiply(vec.Z()));
		dat[13] = dat[14].add(dat[1].multiply(vec.X())).add(dat[5].multiply(vec.Y())).add(dat[9].multiply(vec.Z()));
		dat[14] = dat[13].add(dat[2].multiply(vec.X())).add(dat[6].multiply(vec.Y())).add(dat[10].multiply(vec.Z()));
		modified = true;
		return this;
	}
	 ...
	 * @return This
	 */
	public HDQRef rotateLocally(HDQAng ang) {
		BigDecimal[] r = new BigDecimal[9], d = new BigDecimal[16];
		r[0] = ang.cos().add(ang.X().multiply(ang.X().multiply((ONE.subtract(ang.cos())))));
		r[1] = ang.Y().multiply(ang.X()).multiply(ONE.subtract(ang.cos())).add(ang.Z().multiply(ang.sin()));
		r[2] = ang.X().multiply(ang.Z()).multiply(ONE.subtract(ang.cos())).subtract(ang.Y().multiply(ang.sin()));
		r[3] = ang.X().multiply(ang.Y()).multiply(ONE.subtract(ang.cos())).subtract(ang.Z().multiply(ang.sin()));
		r[4] = ang.cos().add(ang.Y().multiply(ang.Y().multiply((ONE.subtract(ang.cos())))));
		r[5] = ang.Y().multiply(ang.Z()).multiply(ONE.subtract(ang.cos())).add(ang.X().multiply(ang.sin()));
		...
		d[4] = r[0].multiply(dat[4]).add(r[3].multiply(dat[5])).add(r[6].multiply(dat[6]));
		d[5] = r[1].multiply(dat[4]).add(r[4].multiply(dat[5])).add(r[7].multiply(dat[6]));
		d[6] = r[2].multiply(dat[4]).add(r[5].multiply(dat[5])).add(r[8].multiply(dat[6]));
		d[8] = r[0].multiply(dat[8]).add(r[3].multiply(dat[9])).add(r[6].multiply(dat[10]));
		d[9] = r[1].multiply(dat[8]).add(r[4].multiply(dat[9])).add(r[7].multiply(dat[10]));
		d[10] = r[2].multiply(dat[8]).add(r[5].multiply(dat[9])).add(r[8].multiply(dat[10]));
		d[12] = r[0].multiply(dat[12]).add(r[3].multiply(dat[13])).add(r[6].multiply(dat[14]));
		d[13] = r[1].multiply(dat[12]).add(r[4].multiply(dat[13])).add(r[7].multiply(dat[14]));
		d[14] = r[2].multiply(dat[12]).add(r[5].multiply(dat[13])).add(r[8].multiply(dat[14]));
		d[15] = ONE;
	 ...
	 * @return This
	 */
	public HDQRef rotateGlobally(HDQAng ang) {
		BigDecimal[] r = new BigDecimal[9], d = new BigDecimal[16];
		r[0] = ang.cos().add(ang.X().multiply(ang.X().multiply((ONE.subtract(ang.cos())))));
		r[1] = ang.Y().multiply(ang.X()).multiply(ONE.subtract(ang.cos())).add(ang.Z().multiply(ang.sin()));
		r[2] = ang.X().multiply(ang.Z()).multiply(ONE.subtract(ang.cos())).subtract(ang.Y().multiply(ang.sin()));
		...
		d[0] = (dat[0].multiply(r[0])).add(dat[4].multiply(r[1])).add(dat[8].multiply(r[2])).add(dat[12]);
		d[1] = (dat[1].multiply(r[0])).add(dat[5].multiply(r[1])).add(dat[9].multiply(r[2])).add(dat[13]);
		d[2] = (dat[2].multiply(r[0])).add(dat[6].multiply(r[1])).add(dat[10].multiply(r[2])).add(dat[14]);
		d[4] = (dat[0].multiply(r[3])).add(dat[4].multiply(r[4])).add(dat[8].multiply(r[5])).add(dat[12]);
		d[5] = (dat[1].multiply(r[3])).add(dat[5].multiply(r[4])).add(dat[9].multiply(r[5])).add(dat[13]);
		d[6] = (dat[2].multiply(r[3])).add(dat[6].multiply(r[4])).add(dat[10].multiply(r[5])).add(dat[14]);
		d[8] = (dat[0].multiply(r[6])).add(dat[4].multiply(r[7])).add(dat[8].multiply(r[8])).add(dat[12]);
		d[9] = (dat[1].multiply(r[6])).add(dat[5].multiply(r[7])).add(dat[9].multiply(r[8])).add(dat[13]);
		d[10] = (dat[2].multiply(r[6])).add(dat[6].multiply(r[7])).add(dat[10].multiply(r[8])).add(dat[14]);
		d[12] = (dat[0].multiply(r[6])).add(dat[4].multiply(r[7])).add(dat[8].multiply(r[8])).add(dat[12]);
		d[13] = (dat[1].multiply(r[6])).add(dat[5].multiply(r[7])).add(dat[9].multiply(r[8])).add(dat[13]);
		d[14] = (dat[2].multiply(r[6])).add(dat[6].multiply(r[7])).add(dat[10].multiply(r[8])).add(dat[14]);
		d[15] = ONE;
	 ...
	 * @return This
	 */
	public HDQRef multiplyLocally(HDQRef ref) {
	 ...
	 * @return This
	 */
	public HDQRef multiplyGlobally(HDQRef ref) {
	...
	public boolean equals(Object obj) {
		return obj instanceof HDQRef && Arrays.equals(dat, ((HDQRef) obj).dat);
	}
