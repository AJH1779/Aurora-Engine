...
public final class LDAng {
     ...
     */
    public LDAng(float ang, float x, float y, float z) { set(ang, x, y, z); }
    /**
     ...
     * @param ang The rotation angle in radians
     */
    public LDAng(float ang, LDVec vec) { set(ang, vec); }
    /**
     ...
     * @return This
     */
    public LDAng set(float ang, LDVec vec) { set(vec); return set(ang); }
    /**
